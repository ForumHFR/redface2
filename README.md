...
- **Bêta publique 0.62.0** (22 septembre 2026) : raccourcis Première page / Dernière page dans le sélecteur de page des sujets et des MP, position de lecture restaurée au retour à la page précédente d'un sujet, et confirmation explicite après l'envoi d'un message — y compris depuis la liste des drapeaux.
- **Canal dev** : aligné sur la bêta (0.62.0) au 22 septembre 2026 ; il reçoit les releases dev suivantes avant leur promotion.
