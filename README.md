...
- **Bêta publique 0.60.0** (20 septembre 2026) : sélection de texte fluide au-delà de l'écran et curseur maintenu visible dans l'éditeur, désélection par tap extérieur dans les sujets et MP, clavier corrigé sur Android 10, bannière d'aide quand le sélecteur d'images ne renvoie rien.
- **Canal dev** : aligné sur la bêta (0.60.0) au 20 septembre 2026 ; il reçoit les releases dev suivantes avant leur promotion.
