...
| **2 — Écriture** | Post / edit / quote / create topic / recherche | L | Phase 1 | En close-out |
...
- [ ] **Médias éditeur Phase 2F-E (#11 suite)** — helper MVP d'insertion d'image par URL (`[img]url[/img]`). Upload/rehost, favoris/récents smileys, GIFs externes et sync MPStorage sont différés aux phases ultérieures.
