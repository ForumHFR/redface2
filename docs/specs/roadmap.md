...
- [x] Reply MP classique (#301) — le FAB global « Répondre » uniquement. **La citation par message n'a jamais été livrée** (sur le formulaire `message.php` suivi par la production, `numrep` est vide ; le dernier message de la page n'est prérempli que par la réponse rapide embarquée — trois sens mesurés en #1041, cf. [protocol-hfr.md]({{ site.baseurl }}/specs/protocol-hfr)) : claim « quote » retiré le 2026-08-12 (#1041), la citation MP est portée par le lot 4 de #1040
- [x] Nouveau MP — création
- [x] MultiMPs — liste avec vue drapeaux, lecture, reply (onglet « DT » des Drapeaux listant les MultiMP + reprise de lecture MPStorage livré 2026-06-19, app-v166 ; comme pour les MP classiques, aucune citation par message — claim « quote » retiré le 2026-08-12, #1041)
