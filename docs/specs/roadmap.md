...
- [x] Reply MP classique (#301) — le FAB global « Répondre » uniquement. **La citation par message n'a jamais été livrée** (le `numrep` du formulaire MP est le dernier message de la page, pas une référence de citation) : claim « quote » retiré le 2026-08-12 (#1041), la citation MP est portée par le lot 4 de #1040
