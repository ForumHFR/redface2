...
- **Bêta publique 0.62.0** (22 septembre 2026, Play test ouvert + F-Droid) : raccourcis Première page / Dernière page dans le sélecteur de page des sujets et des MP, position de lecture restaurée au retour à la page précédente d'un sujet, et confirmation explicite après l'envoi d'un message — y compris depuis la liste des drapeaux. Détail par version dans [`app/CHANGELOG.md`](https://github.com/ForumHFR/redface2/blob/main/app/CHANGELOG.md).
- **Canal dev** : aligné sur la bêta (0.62.0) au 22 septembre 2026 ; il reçoit les releases dev suivantes avant leur promotion en bêta.
