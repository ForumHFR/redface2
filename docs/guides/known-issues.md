...
- **Visionneuse d'images — plein écran au tap, plus à l'ouverture (#1388).** Depuis la 0.59.0, la visionneuse n'impose plus le plein écran : à l'ouverture, sa barre d'actions et les barres système Android sont visibles ensemble (modèle Google Photos) ; un tap simple masque les deux, un second les ramène, et l'état d'avant ouverture est restauré à la fermeture. Le réglage « mode immersif » (#518) borne la règle : s'il est actif, la barre de navigation Android reste masquée en permanence, comme ailleurs dans l'app. Conséquence directe : quand la barre d'actions est visible, la barre Android est « réelle » (ses insets sont dépêchés) et la barre d'actions se pose au-dessus — plus de chevauchement.
