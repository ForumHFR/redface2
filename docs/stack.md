...
Voir `docs/navigation.md` pour les exemples concrets (`NavDisplay`, `SceneStrategy`, deep linking, predictive back) et [ADR-008]({{ site.baseurl }}/adr/008-compose-navigation-3) pour la décision.
