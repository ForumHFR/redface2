...
val RedfaceLightColorScheme = lightColorScheme(
    ...
    // Slate tertiary shared by every palette (#883): replaces the amber that read as "yellow"
    // on the anchor-post band, armed submit button and alternating quote rails.
    tertiary = Color(0xFF56616C),
    onTertiary = Color(0xFFFFFFFF),
    tertiaryContainer = Color(0xFFDAE5F1),
    onTertiaryContainer = Color(0xFF131C26),
...
val RedfaceDarkColorScheme = darkColorScheme(
    ...
    tertiary = Color(0xFFBEC8D4),
    onTertiary = Color(0xFF28323D),
    tertiaryContainer = Color(0xFF3E4854),
    onTertiaryContainer = Color(0xFFDAE4F1),
